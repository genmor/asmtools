...
This R package bundles a handful of functions written to load and compare outputs from programs such as samtools, BUSCO/compleasm, BBMap, inspector, and Juicbox. Using outputs from these programs, `asmtools` allows the users to do the following in an interactive R session:
